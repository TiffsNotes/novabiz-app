...
export default function ProcurementPage() {
  ...
  useEffect(() => {
    fetch('/api/erp?view=purchase_orders')
      .then(r => r.ok ? r.json() : {})
      .then(d => {
  ...
  return (
    <DashboardLayout>
      <div className="h-full flex flex-col">
        <PageHeader
          title="Procurement"
          subtitle="Purchase orders, vendor management, and receiving"
        ...
        <div className="flex-1 overflow-auto p-4">
          {loading ? (
            ...
            <EmptyState icon={Truck} title="No Procurement yet" description="Purchase orders, vendor management, and receiving — connect your data sources to populate this module." />
          ) : (
            <Card padding={false}>
              <div className="p-4">
