    ...
    <DashboardLayout>
      <div className="h-full flex flex-col">
        <PageHeader
          ...
          subtitle="Journal entries, chart of accounts, and trial balance"
        ...
        <div className="flex-1 overflow-auto p-4">
          {loading ? (
            ...
            <EmptyState icon={DollarSign} title="No General Ledger yet" description="Journal entries, chart of accounts, and trial balance — connect your data sources to populate this module." />
          ) : (
            <Card padding={false}>
              <div className="p-4">
