...
export default function SalesOrdersPage() {
  ...
  useEffect(() => {
    fetch('/api/erp?view=sales_orders')
      .then(r => r.ok ? r.json() : {})
      .then(d => {
  ...
  return (
    <DashboardLayout>
      <div className="h-full flex flex-col">
        <PageHeader
          title="Orders"
          subtitle="Sales orders, fulfillment, and shipping"
        ...
        <div className="flex-1 overflow-auto p-4">
          {loading ? (
            ...
            <EmptyState icon={ShoppingCart} title="No Orders yet" description="Sales orders, fulfillment, and shipping — connect your data sources to populate this module." />
          ) : (
            <Card padding={false}>
              <div className="p-4">
