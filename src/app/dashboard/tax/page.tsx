...
export default function TaxPage() {
  ...
  useEffect(() => {
    fetch('/api/finance?view=tax_filings')
      .then(r => r.ok ? r.json() : {})
      .then(d => {
    ...
    <DashboardLayout>
      <div className="h-full flex flex-col">
        <PageHeader
          ...
          subtitle="Tax deadlines, filings, and compliance calendar"
        ...
        <div className="flex-1 overflow-auto p-4">
          {loading ? (
            ...
            <EmptyState icon={Shield} title="No Tax & Compliance yet" description="Tax deadlines, filings, and compliance calendar — connect your data sources to populate this module." />
          ) : (
            <Card padding={false}>
              <div className="p-4">
